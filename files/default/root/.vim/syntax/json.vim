...
syn region  jsonHashBlock   matchgroup=jsonBraces start="{"   end="}"     skip=+"+ extend fold transparent
syn region  jsonArrayBlock  matchgroup=jsonBraces start="\["  end="\]"    skip=+"+ extend fold transparent
